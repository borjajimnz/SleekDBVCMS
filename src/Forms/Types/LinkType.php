...
class LinkType extends AbstractType
{
    ...
    public function render(string $name, $value = null, array $attributes = []): string
    {
        ...
        $selectAttrs = [
            'class' => 'w-full px-3 py-2 rounded-lg border border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 disabled:opacity-60 disabled:cursor-not-allowed',
        ];
        if ($disabled) {
